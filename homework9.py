...
table = [box(pos=( 200,0,0), length=1,height=400,width=1, color=color.white),\
         ...
         box(pos=(0,-200,0), length=400,height=1,width=1, color=color.white)]
wall = sphere(pos=(0-alpha,0,0), radius=wall_radius, color=color.red)
...
pyplot.scatter(x, y)
pyplot.savefig("billiard_"+str(alpha)+"_"+str(wall_radius)+".png",dpi=72)
pyplot.show()